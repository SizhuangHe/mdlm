...
sample_steps=1000
temperature=0.5
checkpoint_path=/gpfs/radev/scratch/dijk/sh2748/CaLMDD/benchmarking_runs/lm1b/2025.01.20/211640/checkpoints/best.ckpt
fasta_folder="/gpfs/radev/scratch/dijk/sh2748/CaLMDD/benchmarking_runs/lm1b/2025.01.20/211640/eval_results/T_${temperature}/${sample_steps}_steps"
...
# echo "Sampling step is ${sample_steps}"
# echo "The model is SEDD"
